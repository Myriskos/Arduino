...
//--------------------------------------------
 ...
 therm1_btn.initButton(&tft,  60, 100, 120, 40, WHITE, CYAN, BLACK, "Lebhtas1", 2);
 therm2_btn.initButton(&tft,  60, 150, 120, 40, WHITE, CYAN, BLACK, "kiklofo2", 2);
 therm3_btn.initButton(&tft,  60, 200, 120, 40, WHITE, CYAN, BLACK, "boiller3", 2);
...
//     tft.setTextSize(2);
   //----------------------------------------
    ...
    if (therm2_btn.justPressed()) {
        ...
        therm2 =   therm_setup( "Kykloforhths" , therm2   ) ;
        EEPROM.put( 20,therm2);
    }
    if (therm3_btn.justPressed()) {
        therm3_btn.drawButton(true);
        therm3 =   therm_setup( "Boyller" , therm3   ) ;
