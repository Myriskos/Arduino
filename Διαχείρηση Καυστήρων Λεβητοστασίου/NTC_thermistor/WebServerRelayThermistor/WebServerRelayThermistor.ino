...
const char* ssid     = "VODAFONE_0112";
const char* password = "hu2tar4f5542smcc";
...
void loop() {
  ...
  Serial.print(temperature1);
            ...
            client.println("th { padding: 12px; background-color: #1d6332; color: white; }");  //#27AD4F
            client.println("tr { border: 1px solid #ddd; padding: 12px; }");
            client.println("tr:hover { background-color: #B6FF00; }"); // #B6FF00
            client.println("td { border: none; padding: 12px; }");
            client.println(".sensor { color:white; font-weight: bold; background-color: #425748; padding: 1px; }");
 ...
 *  where A = 0.001129148, B = 0.000234125 and C = 8.76741*10^-8  */
  ...
  temp = temp - 277.15;  // Temperature in degree celsius   //273.15
