...
//--------------------------------------------
 ...
 if (dispMenu){
    ...
    therm03= 45 ;  //(sensors.getTempCByIndex(2));
 
    String Shead = "" ;
    if (Pellet_on){
     Shead =  "Pellet" ;
    therm0= 25.00 ; //(sensors.getTempCByIndex(0));  
     delay(100) ;
    }
    else if (Oil_on) {
     Shead =  " Oil  " ; 
    therm0=  25.00 ; // (sensors.getTempCByIndex(1));  
     delay(100) ;
   }
    else {
     Shead =  " No Mode " ; 
   ...
   // if (therm0 < 0 ) ; goto ReadSensor ; 
     ...
     dispMenu = false ;
       ...
       //---------------------------------------------------
            ...
            sensors.requestTemperatures ();
            therm03= 45.00 ; //(sensors.getTempCByIndex(2));
              String Shead = "" ;
              if (Pellet_on){
               Shead =  "Pellet" ;
               Levitas = "L01" ;
         ...
         //-------------------------------------------
           ...
           //  strSendSereal = "T23.00T45.00T75.00T40.00T45.00L01L01K02B02" ;
